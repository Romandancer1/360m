...
let liQuotes = __webpack_require__(1);
let hoverCityLink = __webpack_require__(2);
let Sticky = __webpack_require__(3);
let changeTabs = __webpack_require__(4);
...
function _classCallCheck(t, i) {
  ...
  function t() {
    ...
    this.css(t, { position: "", width: "", top: "", left: "" });var i = Math.max(t.offsetWidth, t.clientWidth, t.scrollWidth),
        ...
        s = 0,
        o = 0;do s += t.offsetTop || 0, o += t.offsetLeft || 0, t = t.offsetParent; while (t);return { top: s, left: o, width: i, height: e };
